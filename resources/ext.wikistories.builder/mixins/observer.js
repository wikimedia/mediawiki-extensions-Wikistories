 ...
 * @file observer.js
 *
 * Re-usable mixin to add IntersectionObserver functionality to a component.
 * The mixins automatically bind the root element to the observer.
 * The mixins is flexible, as it allows the user to modify certain value to fulfil their needs.
 *
 * Taken from: https://github.com/wikimedia/mediawiki-extensions-MediaSearch
 */
module.exports = {
	data: function () {
		return {
